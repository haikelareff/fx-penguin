...
export function BrokerDetailPage({ broker }: BrokerDetailPageProps) {
  ...
  const getPlatformBadgeColor = (platform: string) => {
    const colors: Record<string, string> = {
      MT4: "bg-blue-100 text-blue-800 border-blue-200 dark:bg-blue-900 dark:text-blue-200",
      MT5: "bg-green-100 text-green-800 border-green-200 dark:bg-green-900 dark:text-green-200",
      cTrader: "bg-purple-100 text-purple-800 border-purple-200 dark:bg-purple-900 dark:text-purple-200",
    }
    return colors[platform] || "bg-gray-100 text-gray-800 border-gray-200 dark:bg-gray-800 dark:text-gray-200"
  }
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container max-w-6xl mx-auto px-2 sm:px-4 py-4 sm:py-8">
        ...
        {/* Broker Header */}
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-8 mb-4 sm:mb-8">
          <div className="flex-1">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h1 className="text-xl sm:text-3xl font-bold mb-2">{broker.brokerName}</h1>
                <p className="text-sm sm:text-base text-muted-foreground mb-3">{broker.description}</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div className="text-center p-2 sm:p-3 bg-muted/50 rounded-lg">
                <Calendar className="h-4 w-4 sm:h-5 sm:w-5 mx-auto mb-1 text-muted-foreground" />
                <div className="text-xs sm:text-sm font-medium">Founded</div>
                <div className="text-xs text-muted-foreground">{broker.founded}</div>
              </div>
              <div className="text-center p-2 sm:p-3 bg-muted/50 rounded-lg">
                <MapPin className="h-4 w-4 sm:h-5 sm:w-5 mx-auto mb-1 text-muted-foreground" />
                <div className="text-xs sm:text-sm font-medium">Headquarters</div>
                <div className="text-xs text-muted-foreground">{broker.headquarters}</div>
              </div>
              <div className="text-center p-2 sm:p-3 bg-muted/50 rounded-lg">
                <Globe className="h-4 w-4 sm:h-5 sm:w-5 mx-auto mb-1 text-muted-foreground" />
                <div className="text-xs sm:text-sm font-medium">Website</div>
                <div className="text-xs text-muted-foreground">Official Site</div>
              </div>
              <div className="text-center p-2 sm:p-3 bg-muted/50 rounded-lg">
                <Shield className="h-4 w-4 sm:h-5 sm:w-5 mx-auto mb-1 text-muted-foreground" />
                <div className="text-xs sm:text-sm font-medium">Regulation</div>
          ...
          <div className="lg:w-80">
            <Card>
              <CardHeader>
                <CardTitle className="text-center text-lg">Start Trading</CardTitle>
        ...
        <Tabs defaultValue="accounts" className="w-full">
          ...
          <div className="min-h-[600px] sm:min-h-[800px] mt-6">
            {/* Account Types Tab */}
            <TabsContent value="accounts" className="space-y-4 sm:space-y-6 m-0">
              <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
                {broker.accountTiers.map((account, index) => (
                  <Card
                    key={index}
                    className={`cursor-pointer transition-all h-fit ${
                      selectedAccount.name === account.name ? "ring-2 ring-primary" : ""
                    }`}
                  ...
                  >
                    <CardHeader>
                      <CardTitle className="flex items-center justify-between text-base sm:text-lg">
                        {account.name}
                        {account.name === "Pro Account" && <Badge className="bg-yellow-500 text-white">Popular</Badge>}
                      </CardTitle>
            ...
            <TabsContent value="platforms" className="space-y-4 sm:space-y-6 m-0">
              <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
                {broker.tradingPlatforms.map((platform) => (
                  <Card key={platform} className="h-fit">
                    <CardHeader>
            ...
            <TabsContent value="instruments" className="space-y-4 sm:space-y-6 m-0">
              <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
                {broker.tradingInstruments.map((instrument) => (
                  <Card key={instrument} className="h-fit">
                    <CardHeader>
            ...
            {/* Payment Methods Tab */}
            <TabsContent value="payments" className="space-y-4 sm:space-y-6 m-0">
              <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                {/* Deposit Options */}
                <Card className="h-fit">
                  <CardHeader>
                    <CardTitle className="text-primary">Deposit Methods</CardTitle>
                ...
                <Card className="h-fit">
                  <CardHeader>
                    <CardTitle className="text-blue-600">Withdrawal Methods</CardTitle>
            ...
            {/* Features Tab */}
            <TabsContent value="features" className="space-y-4 sm:space-y-6 m-0">
              <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                {/* Trading Features */}
                <Card className="h-fit">
                  <CardHeader>
